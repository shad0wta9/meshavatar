...
from dataset.dataset_smpl import DatasetSMPL, TestDatasetSMPL
from dataset.dataset_actorshq import DatasetActorsHQ, TestDatasetActorsHQ
...
if __name__ == "__main__":
    ...
    if os.path.isfile(os.path.join(FLAGS.data_dir, 'calibration_full.json')):
        ...
        dataset = TestDatasetActorsHQ(FLAGS.data_dir, glctx, FLAGS)
    ...
    start_frame, end_frame, freq = 1000, 1400, 5
    test = True
    export_img = True
