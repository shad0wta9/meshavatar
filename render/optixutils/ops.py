...
def optix_env_shade(optix_ctx, mask, ro, gb_pos, gb_normal, gb_view_pos, gb_kd, gb_ks, light, pdf, rows, cols, BSDF='pbr-optix', n_samples_x=8, rnd_seed=None, shadow_scale=1.0):
    iBSDF = ['pbr-optix', 'diffuse-optix', 'white-optix'].index(BSDF) # Ordering important, must match the order of the fwd/bwdPbrBSDF kernel.
